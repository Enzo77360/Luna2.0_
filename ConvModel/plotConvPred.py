...
model_path = 'P:\Codes Python\Luna2.0_\ConvModel\Trained_Conv_2000.h5'
with custom_object_scope({'ExpandDimsLayer': ExpandDimsLayer, 'rmse': rmse}):
    model = load_model(model_path)

# Chemin vers le fichier CSV contenant le nouveau dataset
csv_file = "P:\OhLeGrosDataset\output_data_core250μm_gasN2_pressure1.5bar_time28fs_length1m_energy50μJ.csv"
...
Iw_dB = 10 * np.log10(Iw)  # Ajout d'une petite valeur pour éviter le log(0)
...
predictions = model.predict([x_seq_real_repeated, conditions_expanded_array])
...
# Titre de la figure
fig.suptitle('Convolution Model', fontsize=16)
...
# Titre de la figure
fig2.suptitle('Convolution Model', fontsize=16)
# Étapes spécifiques
steps = [2, 25, 100]
